...
Questions people asked in the Antigravity forums in September 2026, each with the place on this page that answers it.
...
**Which rules and workflows do people use?** See the section Guides and tips.
...
- [n8n vibe coding skill](https://github.com/MichaelZelbel/awesome-antigravity/blob/main/intelligence/skills/n8n-vibe-coding-skill.md) - Build n8n workflows from inside the agent. Lives in this repository.
...
- [The unofficial Antigravity guide](https://github.com/MichaelZelbel/awesome-antigravity/blob/main/ANTIGRAVITY_GUIDE.md) - Setup, core concepts and working habits. Lives in this repository.

### Where skills, rules, plugins and MCP settings go
